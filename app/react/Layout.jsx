        ...
        return (
            <html>
                <head>
                    ...
                    <script src={assets('js/require.js')} data-main={assets(this.props.mainScript)} type='text/javascript'></script>
                ...
                <body>
                    ...
                    <script async src={assets(this.props.footerScript)}></script>
                </body>
            </html>
        )
    }
